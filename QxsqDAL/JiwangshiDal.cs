...
namespace QxsqDAL
{
    public class JiwangshiDal
    {
        ...
        public static void AddJiwangshi(JiwangshiDto jiwangshiDto)
        {
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(myconn, CommandType.StoredProcedure, "CreateJiwangshi", arParames);
}
        ...
        public static void UpdateJiwangshi(JiwangshiDto jiwangshiDto)
        {
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(myconn, CommandType.StoredProcedure, "UpdateJiwangshi", arParames);
}
            catch (SqlException ex)
            {
                throw ex;
